      ...
      <div className="overflow-x-hidden page-enter">
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
            <span
              className="font-serif text-[18vw] font-bold italic whitespace-nowrap"
          ...
          <FadeIn className="relative z-10 max-w-[600px] mx-auto text-center">
            ...
            >
              No fluff. Just the strategies, stories, and permission slips you
              need to lead boldly.
            </p>

            {/* TODO: Replace with GoHighLevel form embed */}
            <form
            ...
            >
              <input
                ...
                className="flex-1 px-5 font-sans text-sm text-white placeholder:text-white/40 outline-none focus:border-brand-pink transition-colors"
                style={{
                  height: "48px",
                  background: "#161616",
              ...
              <button
                type="submit"
                className="btn-glow bg-brand-pink text-white px-8 font-sans text-[11px] font-semibold uppercase tracking-[0.15em] hover:bg-brand-pink/90 transition-colors whitespace-nowrap"
