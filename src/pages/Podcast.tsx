                ...
                <div className="flex flex-wrap md:flex-nowrap gap-2.5 mb-10">
                  {[
                    ...
                    <a key={p.name} href={p.href} target="_blank" rel="noopener noreferrer"
                      onClick={() => { try { trackPodcastPlatformClick(toPlatformKey(p.name), 'podcast_page_hero'); } catch { /* analytics must never break the page */ } }}
            ...
            {[
              ...
              <FadeIn key={platform.name} delay={i * 80} y={15}>
                <a href={platform.href} target="_blank" rel="noopener noreferrer"
                  onClick={() => { try { trackPodcastPlatformClick(toPlatformKey(platform.name), 'podcast_page_listen_section'); } catch { /* analytics must never break the page */ } }}
